# NovaDroid — dependency installer for Windows (Chocolatey + official Metasploit MSI).
...
if ($Components -ne "") {
    ...
    Write-Host ""
    Write-Host "NovaDroid — Windows dependency installer" -ForegroundColor Green
...
Write-Info "  python novadroid.py"
Write-Host ""
