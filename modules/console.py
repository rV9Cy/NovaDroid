...
def _format_submenu_header(breadcrumb: list[str]) -> str:
    """Build header: NovaDroid · Hub · Nested (skip Main Menu)."""
    parts = [p for p in breadcrumb if p != "Main Menu"]
    trail = " · ".join(parts)
    return f"\n  [bold cyan]NovaDroid[/bold cyan]  ·  [bold white]{trail}[/bold white]\n"
...
def render_submenu_screen(
    ...
    *,
    ...
    if breadcrumb:
        ...
        console.print(f"\n  [bold cyan]NovaDroid[/bold cyan]  ·  [bold white]{title}[/bold white]\n")
